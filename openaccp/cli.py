    ...
    return {
        ...
        target / "card-registry.md": "\n".join(
            [
                ...
                "| Backend / API / services | unclear | SRC-001 | none | Not enough facts yet. |",
                "| Data / storage / migration | unclear | SRC-001 | none | Not enough facts yet. |",
                "| Frontend / UI / design system | unclear | SRC-001 | none | Not enough facts yet. |",
                "| Desktop shell / Electron / Tauri | unclear | SRC-001 | none | Not enough facts yet. |",
                "| Mobile / native surfaces | unclear | SRC-001 | none | Not enough facts yet. |",
                "| Integrations / external systems | unclear | SRC-001 | none | Not enough facts yet. |",
                "| Auth / security / privacy | unclear | SRC-001 | none | Not enough facts yet. |",
                "| Testing / QA / validation | unclear | SRC-001 | none | Not enough facts yet. |",
                "| Observability / CI / release / ops | unclear | SRC-001 | none | Not enough facts yet. |",
                "",
        ...
        target / "coordination" / "runtime-boundary.json": json_text(
            {
                ...
                "dataRisk": "low",
                "unresolvedOwnerInputs": ["productRepoPath", "baseBranch", "sourceRoots", "testEntrypoints", "worktreePolicy"],
                "b2DispatchGate": {
                ...
                "decisions": [
                    {
                        ...
                        "type": "owner-question",
                        "status": "open",
                        "question": "What product repo path, base branch, source roots, test entrypoints, and worktree policy should B2 work use?",

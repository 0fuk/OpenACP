...
| Gate | Example documentation slice. |
| Area | Single worker flow. |
| Goal | Show how reviewed evidence reaches a final-authority decision point. |
| Gaps | Final consume and release checks are not included in this example. |
| Next | The final authority should inspect the handoff and review report, then decide accept, amend, or reject. |

...
End every reply with `Human Next Step` / `给人的下一步`. If the human does not need to act, say that and name the Primary or Frontier consume action that should happen next.
